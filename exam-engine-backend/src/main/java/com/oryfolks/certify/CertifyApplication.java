...
public class CertifyApplication {
    ...
    @Bean
    public CommandLineRunner initDatabase(UserRepository userRepository, ExamRepository examRepository, QuestionRepository questionRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            // 1. Seed Users
            ...
            if (examRepository.count() == 0) {
                ...
                List<CompetencyBand> bands = List.of(
                        CompetencyBand.builder().exam(selenium).levelName("L1").title("Expert").minScore(90).maxScore(100).build(),
                        CompetencyBand.builder().exam(selenium).levelName("L2").title("Advanced").minScore(75).maxScore(89).build(),
                        CompetencyBand.builder().exam(selenium).levelName("L3").title("Intermediate").minScore(60).maxScore(74).build(),
                        CompetencyBand.builder().exam(selenium).levelName("L4").title("Beginner").minScore(40).maxScore(59).build(),
                        CompetencyBand.builder().exam(selenium).levelName("L5").title("Needs Training").minScore(0).maxScore(39).build()
                );
                ...
                List<CompetencyBand> apiBands = List.of(
                        CompetencyBand.builder().exam(apiExam).levelName("L1").title("Expert").minScore(90).maxScore(100).build(),
                        CompetencyBand.builder().exam(apiExam).levelName("L2").title("Advanced").minScore(75).maxScore(89).build(),
                        CompetencyBand.builder().exam(apiExam).levelName("L3").title("Intermediate").minScore(60).maxScore(74).build(),
                        CompetencyBand.builder().exam(apiExam).levelName("L4").title("Beginner").minScore(40).maxScore(59).build(),
                        CompetencyBand.builder().exam(apiExam).levelName("L5").title("Needs Training").minScore(0).maxScore(39).build()
                );
                ...
                devops.setCompetencyBands(List.of(
                        CompetencyBand.builder().exam(devops).levelName("L1").title("Expert").minScore(90).maxScore(100).build(),
                        CompetencyBand.builder().exam(devops).levelName("L2").title("Advanced").minScore(75).maxScore(89).build(),
                        CompetencyBand.builder().exam(devops).levelName("L3").title("Intermediate").minScore(60).maxScore(74).build(),
                        CompetencyBand.builder().exam(devops).levelName("L4").title("Beginner").minScore(40).maxScore(59).build(),
                        CompetencyBand.builder().exam(devops).levelName("L5").title("Needs Training").minScore(0).maxScore(39).build()
                ));
