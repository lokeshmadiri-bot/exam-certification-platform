...
export default function TimeUpModal({ isOpen }) {
  ...
  return (
    <div className="run-overlay fixed inset-0 z-[9999] bg-[#061222]/90 backdrop-blur-md flex items-center justify-center p-6 select-none">
      <div className="ov-card bg-[#0e2745] border-2 border-[#F2A93B] rounded-2xl p-[36px_40px] text-center max-w-[430px] w-full shadow-2xl relative animate-[scaleIn_0.3s_ease-out]">
